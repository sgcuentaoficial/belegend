      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between mb-12">
          <div>
            ...
            <p className="text-gray-600">Latest arrivals for peak performance</p>
          </div>
          ...
          {products.map((product) => (
            ...
            >
              <div className="relative aspect-[3/4] overflow-hidden bg-gray-50">
                ...
                {/* Wishlist */}
                <button className={`absolute top-3 right-3 z-10 w-8 h-8 bg-white rounded-full flex items-center justify-center transition-all duration-300 ${
              ...
              <div className="p-4">
                ...
                <div className="flex items-center mb-2">
                  <div className="flex items-center">
                    {[...Array(4)].map((_, i) => (
                      <div key={i} className="w-2 h-2 bg-black mr-1"></div>
                    ))}
